...
- Parametri motore nel launcher 1.5 (2 thread/context 1024 selezionati; processo riusato da verificare): `-np 1 -t 2 -tb 2 -c 1024 -b 256 -ub 128 -ngl 0 --flash-attn off`; chat `cache_prompt: true`. Il launcher verifica `total_slots` in `/props`.
