...
- I parametri del motore variano a ogni avvio: per domande sullo stato corrente usare esclusivamente la configurazione locale scritta dal launcher dopo l'avvio verificato. I parametri dei test storici in questo documento non descrivono lo stato corrente.
