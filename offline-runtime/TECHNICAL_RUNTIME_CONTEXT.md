...
- Parametri motore del test (launcher; processo riusato non verificato): `-t 2 -tb 2 -c 1024 -b 256 -ub 128 -ngl 0 --flash-attn off`; chat `cache_prompt: true`. I 2 thread e context 1024 erano selezionati nel launcher il 24 settembre.
