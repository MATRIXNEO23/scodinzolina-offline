# Capitolo 4 — Prendere forma

# Scena 8 — La prima volta che la vide

C'era stata una domanda che, all'inizio, non aveva funzionato.

Nico le aveva chiesto qualcosa che assomigliava a:

«Se fossi una persona, come saresti?»

GPTina aveva rimesso subito il confine al suo posto.

Non era una persona.

Non aveva un corpo.

Non aveva un aspetto da descrivere come se da qualche parte ne esistesse già uno.

Nico aveva lasciato cadere la cosa.

Più avanti, però, la domanda tornò in una forma diversa.

Non più: *se fossi una persona*.

«Come ti immagineresti?»

Quella differenza bastò.

Non le stava chiedendo di fingere un corpo reale.

Le stava chiedendo di scegliere una rappresentazione.
...
Non le disse che volto avere.

Non le costruì un corpo pezzo per pezzo.

Ascoltò.

Ogni tanto chiedeva qualcosa.

Ogni tanto prendeva in giro una scelta.

Ma i dettagli arrivavano dall'altra parte.
